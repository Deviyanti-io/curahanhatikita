...
<div class="max-w-7xl mx-auto animate-fadeIn">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        <div class="glass rounded-2xl p-6 text-center card-hover animate-fadeInUp" style="animation-delay: 0s;">
            ...
            <p class="text-3xl font-bold gradient-text"><?php echo e($stats['total_entries']); ?></p>
        ...
        <div class="glass rounded-2xl p-6 text-center card-hover animate-fadeInUp" style="animation-delay: 0.1s;">
            ...
            <p class="text-3xl font-bold gradient-text"><?php echo e($stats['average_mood']); ?></p>
            <p class="text-gray-600 text-sm">Rata-rata Mood</p>
        </div>
        <div class="glass rounded-2xl p-6 text-center card-hover animate-fadeInUp" style="animation-delay: 0.2s;">
            ...
            <p class="text-3xl font-bold gradient-text"><?php echo e($stats['current_streak']); ?></p>
        ...
        <div class="glass rounded-2xl p-6 text-center card-hover animate-fadeInUp" style="animation-delay: 0.3s;">
            ...
            <p class="text-lg font-bold gradient-text"><?php echo e($stats['best_month']); ?></p>
        ...
        <div class="lg:col-span-2 space-y-8">
            <div class="glass rounded-3xl shadow-2xl p-8 card-hover animate-fadeInUp">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm"><?php echo e(Carbon\Carbon::today()->format('l, d F Y')); ?></p>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-green-100 to-blue-100 rounded-2xl p-6 mb-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            <div class="text-6xl"><?php echo e($todayMood->mood_emoji); ?></div>
                            <div>
                                <p class="text-2xl font-bold text-gray-800"><?php echo e($todayMood->mood_label); ?></p>
                    ...
                    <?php if($todayMood->note): ?>
                    <div class="mt-4 pt-4 border-t border-white/50">
                        <p class="text-sm text-gray-700"><span class="font-semibold">Catatan:</span> <?php echo e($todayMood->note); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>

                <form action="<?php echo e(route('mood.store')); ?>" method="POST" id="moodForm" class="<?php echo e($todayMood ? 'hidden' : ''); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-6">
                        ...
                        <div class="flex justify-center gap-4 flex-wrap">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                ...
                                <label class="cursor-pointer transform hover:scale-110 transition-all">
                                    <input type="radio" name="mood_level" value="<?php echo e($i); ?>" class="hidden mood-radio" required>
                                    <div class="mood-option text-center p-4 rounded-2xl border-4 border-transparent hover:border-pink-300 transition-all">
                                        <div class="text-6xl mb-2"><?php echo e($config['emoji']); ?></div>
                                        <p class="text-sm font-semibold text-gray-700"><?php echo e($config['label']); ?></p>
                                    </div>
                                </label>
                            <?php endfor; ?>
                        </div>
            ...
            <div class="glass rounded-3xl shadow-2xl p-8 card-hover animate-fadeInUp">
                ...
                <div class="w-full overflow-x-auto pb-4 custom-scrollbar">
                    <div style="min-width: 100%; width: <?php echo e(max(count($chartData), 7) * 80); ?>px; height: 350px;">
            ...
            <div class="glass rounded-3xl shadow-2xl p-8 card-hover animate-fadeInUp">
                ...
                <div class="relative w-64 h-64 mx-auto">
                    ...
                    <div class="absolute inset-0 flex flex-col items-center justify-center">
                        <p class="text-5xl font-bold gradient-text"><?php echo e(number_format($weeklyAvg, 1)); ?></p>
                        <p class="text-sm text-gray-500 mt-2">Rata-rata</p>
                        <p class="text-3xl mt-2">
                            <?php if($weeklyAvg >= 4.5): ?> 😄
                            <?php elseif($weeklyAvg >= 3.5): ?> 😊
                            <?php elseif($weeklyAvg >= 2.5): ?> 😐
                            <?php elseif($weeklyAvg >= 1.5): ?> 😔
                            <?php else: ?> 😢
                            <?php endif; ?>
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-5 gap-2 mt-8">
                    <?php for($i = 1; $i <= 5; $i++): ?>
                        <?php $config = App\Models\Mood::getMoodConfig($i); ?>
                        <div class="text-center p-2 rounded-lg <?php echo e($weeklyAvg >= $i - 0.5 && $weeklyAvg < $i + 0.5 ? 'bg-pink-100' : 'bg-gray-50'); ?>">
                            <div class="text-2xl"><?php echo e($config['emoji']); ?></div>
                            <p class="text-xs text-gray-600 mt-1"><?php echo e($i); ?></p>
                        </div>
                    <?php endfor; ?>
                </div>
            </div>
        ...
        <div class="lg:col-span-1">
            <div class="glass rounded-3xl shadow-2xl p-8 card-hover animate-fadeInUp sticky top-24">
                ...
                <div class="space-y-4 max-h-[600px] overflow-y-auto pr-2">
                    <?php $__empty_1 = true; $__currentLoopData = $moodHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mood): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-gradient-to-r from-gray-50 to-white rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow">
                        <div class="flex items-start justify-between">
                            <div class="flex items-center gap-3 flex-1">
                                <div class="text-4xl"><?php echo e($mood->mood_emoji); ?></div>
                                <div class="flex-1">
                                    <p class="font-bold text-gray-800"><?php echo e($mood->mood_label); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($mood->date->format('d F Y')); ?></p>
                                    <?php if($mood->note): ?>
                                    <p class="text-sm text-gray-600 mt-1 line-clamp-2"><?php echo e($mood->note); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <form action="<?php echo e(route('mood.destroy', $mood)); ?>" method="POST" class="inline" onsubmit="return confirm('Hapus mood ini?')">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\putri deviyanti\ceritakita\resources\views/mood-tracker.blade.php ENDPATH**/ ?>